...
async def secure_process_complete(
    ...
    try:
        ...
        # Ensure outputs go to the same directory as original files
        ...
        config_dict = {
            ...
            "output_directory": str(OUTPUT_DIR),  # Use same directory for all outputs
...
async def secure_download_file(
    ...
    # Construct file path
    from pathlib import Path
    # Use the same outputs directory as uploads
