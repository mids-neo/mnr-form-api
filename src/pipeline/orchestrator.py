...
class MedicalFormPipeline:
    ...
    def _find_template(self, template_name: str) -> Optional[str]:
        ...
        # Get project root (two levels up from pipeline module)
        project_root = os.path.dirname(os.path.dirname(os.path.dirname(__file__)))
        
        search_paths = [
            # Primary location: static/templates
            os.path.join(project_root, "static", "templates", template_name),
            # Legacy locations
            os.path.join(os.path.dirname(__file__), "..", "templates", template_name),
            os.path.join(os.getcwd(), "static", "templates", template_name),
